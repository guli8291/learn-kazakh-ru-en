...
import algorithmTypesImg from "@/assets/lesson-11/algorithm-types.jpg";
...
export const lesson11: LessonData = {
  ...
  slides: [
    ...
    },
    {
      ...
      image: algorithmTypesImg,
      videos: [algorithmExamplesVideo.url, branchingFlowVideo.url, algorithmTypesVideo.url],
    },
    {
      type: "interactive",
